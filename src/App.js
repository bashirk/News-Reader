        ...
        <View style={styles.body}>
          ...
          <Overlay visible={overlayVisible}>
            <Text style={{fontSize: 18}}>
              <Text style={{fontWeight: 'bold'}}>News Reader</Text> is a simple news reader for the Web and as a React Native app (Android / iOS). It aggregates news using Algolia's hacker news API
            </Text>
            <Text style={{fontSize: 18, marginTop: 20}}>
              Made by
              <Text
                onPress={() => { onOpenUrl('https://web.facebook.com/groups/DevCAdoEkiti') }}>
                <Text style={[styles.aboutLink, cursorStyle]}>{" "}DevC: Ado-Ekiti!</Text>
              </Text>
              Check out the repo:
              <Text
                onPress={() => { onOpenUrl('https://github.com/devcadoekiti/News-Reader') }}>
                <Text style={[styles.aboutLink, cursorStyle]}>{" "}github.com/devcadoekiti/News-Reader</Text>
              </Text>
            </Text>
          </Overlay>
          ...
          <View style={[styles.column, styles.header,
            ...
            <View style={[styles.row, { height: 50 }]}>
              <View style={styles.row}>
                ...
                <Text style={[{fontWeight: 'bold', paddingLeft: 4}]}>News Reader</Text>
